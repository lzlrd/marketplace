...
printf '%s\n' "[mempalace] The user's voice/conventions may be on record. Before responding, consult the mempalace MCP palace: mcp__mempalace__mempalace_search (rooms: ${rooms}) plus mcp__mempalace__mempalace_kg_query for any relevant preference. Match the established voice/conventions rather than inventing them. If you ask the user a style/preference choice, offer to save it (ask-to-save)."
exit 0
